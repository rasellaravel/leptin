    ...
    <script src="{{asset('public/admin-laptin/assets/js/vendor/flot/jquery.flot.min.js')}}"></script>
    <script src="{{asset('public/admin-laptin/assets/js/vendor/flot/jquery.flot.time.min.js')}}"></script>
    <script src="{{asset('public/admin-laptin/assets/js/vendor/flot/jquery.flot.selection.min.js')}}"></script>
    <script src="{{asset('public/admin-laptin/assets/js/vendor/flot/jquery.flot.animator.min.js')}}"></script>
    <script src="{{asset('public/admin-laptin/assets/js/vendor/flot/jquery.flot.orderBars.js')}}"></script>
    <script src="{{asset('public/admin-laptin/assets/js/vendor/easypiechart/jquery.easypiechart.min.js')}}"></script>

    <script src="{{asset('public/admin-laptin/assets/js/vendor/rickshaw/raphael-min.js')}}"></script> 
    <script src="{{asset('public/admin-laptin/assets/js/vendor/rickshaw/d3.v2.js')}}"></script>
    <script src="{{asset('public/admin-laptin/assets/js/vendor/rickshaw/rickshaw.min.js')}}"></script>

    <script src="{{asset('public/admin-laptin/assets/js/vendor/morris/morris.min.js')}}"></script>

    <script src="{{asset('public/admin-laptin/assets/js/vendor/tabdrop/bootstrap-tabdrop.min.js')}}"></script>
