            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    <a href="{{url('admin/add-product')}}" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-list"></i> Product <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="{{url('admin/add-product')}}">
                          <i class="fa fa-caret-right"></i> Product 
                        </a>
                      </li>
                      <li>
                        <a href="{{url('admin/packeg-product')}}">
                          <i class="fa fa-caret-right"></i> Packege Product 
                        </a>
                      </li>
                  ...
                  <li class="dropdown">
                    <a href="{{url('admin/order')}}" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-list"></i> Order <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="{{url('admin/order')}}">
                          <i class="fa fa-caret-right"></i> Order List 
                        </a>
                      </li>
              ...
              <li class="summary" id="order-summary">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    This week sales
                    <h3 class="media-heading">0000</h3>
                  </div>
                </div>
...
<!-- Mirrored from tattek.sk/minimal/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Aug 2018 14:35:01 GMT -->
</html>
