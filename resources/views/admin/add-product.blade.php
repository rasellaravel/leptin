                  ...
                  <div class="tile-body">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail" placeholder="Enter Product Title" name="title" required>
                      </div>
                      <div class="form-group col-sm-6">
                        <label for="exampleInputPassword1">Product Price</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Product Price" name="price" required>
                      </div>
                      <div class="form-group col-sm-6">
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <input type="file" class="form-control" id="exampleInputEmail" placeholder="link" name="thumb" required>
                      </div>
